  ...
  return (
    <div className="p-4 pb-20 max-w-2xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-2xl font-extrabold text-slate-800">New Service Entry</h2>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 space-y-5">
        ...
        <div>
          ...
          <input type="text" required placeholder="e.g. Mr. Ganesh" className="input-field"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input type="tel" placeholder="e.g. 9876543210" className="input-field"
          ...
          <div>
            ...
            <input type="text" placeholder="e.g. 123 Main St" className="input-field"
        ...
        <div>
          ...
          <textarea className="input-field" rows={3} placeholder="Describe the issue or service performed..."
